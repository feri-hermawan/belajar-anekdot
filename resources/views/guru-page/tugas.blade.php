        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th>12 Januari 2025
                    <th class="text-center"><button class="btn btn-success">Edit</button></th>
                    <th class="text-center"><button class="btn btn-primary">Kerjakan</button></th>
                </tr>
                <tr>
                    <th>2.</th>
                    <th>Membuat Anekdot
                    ...
                    <th class="text-center"><button class="btn btn-success">Edit</button></th>
                    <th class="text-center"><button class="btn btn-primary">Kerjakan</button>
                </tr>
                <tr>
                    <th>3.</th>
                    <th>Membuat Anekdot
